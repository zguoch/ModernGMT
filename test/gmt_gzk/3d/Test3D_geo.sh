...
gmt begin $figname ps
    ...
    # gmt psbasemap -JM$width_fig_x -JZ${width_fig_z}  -Ra -Ba -BwsenZ -Bza+l"Depth (m)" -pz$angle_view  -TdjTR+o3c/-4c+w2c+f+lW,,S, --FONT_TITLE=12p --MAP_TITLE_OFFSET=0.1c
