...
gmt psxy coh.txt -R3/1000/0/1 -JX6il/4.5i -P -Bxa1g3+l"Wavelength (km)" -Byafg+l"Coherence" -BWSne -Sc0.05i -Gred -Ey0.2c/0.5p,red -K -X1.25i > $ps
...
gmt psxy adm.txt -R3/1000/0/2 -JX6il/4.5i -O -Bxa1g3+l"Wavelength (km)" -Byafg+l"Admittance (mGal/km)" -BWSne -Sc0.05i -Ey+w0.2c+p0.5p,red -Gred -K -i0,1+s1000,2+s1000 -Y5.3i >> $ps
